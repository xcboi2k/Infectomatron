...
public class NormalPersonScript : MonoBehaviour
{
    ...
    public Animator secondPlayerAnim;

    public AudioSource normalPersonAudioSource;
    ...
    private void AimandShoot(){
        ...
        if(aim.magnitude > 0.0f){
            ...
            if(Input.GetButtonDown("Jump")){ //Fire1, Jump
                ...
                normalPersonAudioSource.PlayOneShot(fireClip);
    ...
    private void Movement(){
        ...
        secondPlayerAnim.SetFloat("Horizontal", movement.x);
        secondPlayerAnim.SetFloat("Vertical", movement.y);
        secondPlayerAnim.SetFloat("Magnitude", movement.magnitude);
    ...
    void OnTriggerEnter2D(Collider2D target) {
        if(isImmune == false){
            ...
            normalPersonAudioSource.PlayOneShot(hurtClip);
            }
